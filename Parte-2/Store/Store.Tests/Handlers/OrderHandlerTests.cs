...
namespace Store.Tests.Handlers
{
    ...
    public class OrderHandlerTests
    {
        ...
        [TestMethod]
        [TestCategory("Handlers")]
        public void Dado_um_periodo_sem_itens_o_mesmo_nao_deve_ser_gerado()
        {
            Assert.Fail();
        }
        ...
        [TestMethod]
        [TestCategory("Handlers")]
        public void Dado_um_comando_invalido_o_periodo_nao_deve_ser_gerado()
        {
            var command = new CreateOrderCommand();
            command.Customer = "";
            command.ZipCode = "1341080";
        ...
        [TestMethod]
        [TestCategory("Handlers")]
        public void Dado_um_comando_valido_o_periodo_deve_ser_gerado()
        {
            var command = new CreateOrderCommand();
